...
export function seedDatabase(firebase) {
  ...
  const seriesCollectionRef = collection(firebase, "series");
  const filmsCollectionRef = collection(firebase, "films");
